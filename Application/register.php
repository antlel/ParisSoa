							...
							<form action="login.php" method="GET">
								<fieldset>
									...
									<div class="form-group">
										...
										<input class="form-control" id="pseudo" name="pseudo" type="text" placeholder="Saissisez votre prénom" autofocus="true"/>
									</div>
									<div class="form-group">
										<label for="pseudo">Nom:</label>
										<input class="form-control" id="pseudo" name="pseudo" type="text" placeholder="Saissisez votre nom"/>
									</div>
									<div class="form-group">
										<label for="pseudo">Email:</label>
										<input class="form-control" id="pseudo" name="pseudo" type="text" placeholder="Saissisez une adresse email"/>
									</div>
									<div class="form-group">
